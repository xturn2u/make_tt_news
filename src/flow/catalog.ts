...
export const NODE_CATALOG: NodeDefinition[] = [
  ...
  { id: 'script-agent', title: 'Script Agent', subtitle: 'TikTok-Sprechertext', icon: '✦', category: 'agent', acceptsInput: true, providesOutput: true, defaultConfig: { duration: 55, style: 'seriös, klar, schnell' } },
  ...
  { id: 'tts', title: 'Local TTS', subtitle: 'Sprecher lokal', icon: '◖', category: 'media', acceptsInput: true, providesOutput: true, defaultConfig: { voice: '' } },
  { id: 'captions', title: 'Captions', subtitle: 'Untertitel-Layout', icon: 'CC', category: 'media', acceptsInput: true, providesOutput: true, defaultConfig: { style: 'news-bold' } },
