...
const modules:ModuleDef[]=[
  ...
  {moduleId:'assets',label:'Assets',description:'Gemeinsame Medienbibliothek',color:'#16a34a',icon:'A',category:'Tool',singleton:true},
  {moduleId:'research',label:'Recherche',description:'Optional · für alle Flows',color:'#2563eb',icon:'R',category:'Tool',singleton:true},
